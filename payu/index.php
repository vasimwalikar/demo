	...
	<body>
		...
		<div>
			<table>
				...
				<tr><td>success url</td><td><input type="text" name="surl" value="http://localhost/test2/payu/success.php" size="64" /></td></tr>
				<tr><td>failure url</td><td><input type="text" name="furl" value="http://localhost/test2/payu/fail.php" size="64" /></td></tr>
